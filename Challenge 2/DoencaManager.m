...
//                         [[Doenca alloc] initWithNome:@"Apendicite" andCausa: @"Ocorre quando o apêndice vermiforme do intestino fica bloqueado pela acumulação de material alimentar e bactérias." andPrevencao:@"Não há formas de prevenção porque todos nascemos com apêndice." andDescricao: @"A apendicite é uma inflamação dolorosa e perigosa, se não tratada a tempo. Ela é uma emergência médica, da qual se não for tratada pode causar peritonite (infecção generalizada da cavidade abdominal), uma vez que o apêndice inflamado pode estourar e bloquear o intestino. A peritonite pode ser fatal." andSintomas:@[@"Dor de barriga", @"Diarréia", @"Prisão de ventre."] andImagens:@[@"apendicite.png"]],
...
//                         [[Doenca alloc] initWithNome:@"Hérnia de Disco" andCausa:@"Envelhecimento e desgaste excessivo dos discos vertebrais." andPrevencao:@"Evitar forçar a coluna, realizar aquecimentos e alongamentos antes de esforços com a coluna." andDescricao:@"A hérnia de disco é uma doença causada por lesões dos discos que compõem a coluna vertebral. Estes ficam entre as vértebras, e servem para amortecer choques." andSintomas:@[@"Fraqueza", @"Dificuldade de mobilidade", @"Dor na área afetada", @"Rigidez na área afetada"] andImagens:@[]],
