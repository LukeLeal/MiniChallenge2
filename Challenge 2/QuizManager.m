...
-(NSMutableArray *) embaralha{
    //[_alternativasAtuais removeAllObjects];
    NSMutableArray *a = [NSMutableArray arrayWithArray:[[[_perguntas objectAtIndex:_perguntaAtual] alternativas] allObjects]];
    //[NSMutableArray arra]
    //    for (int i = 0; i < [[[_perguntas objectAtIndex:_perguntaAtual] alternativas] count]; i++) {
    //        //[_alternativasAtuais arrayByAddingObjectsFromArray:[(Alternativa *)[[_perguntas objectAtIndex:_perguntaAtual] alternativas] texto]];
    //        [[_alternativasAtuais addObject:[(Alternativa *)[[_perguntas objectAtIndex:_perguntaAtual] alternativas] ]] ;]
    //    }
